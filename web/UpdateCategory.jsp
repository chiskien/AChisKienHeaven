                    ...
                    <div class="table">
                        <div class="row">
                            <div class="cell">
                                ...
                                <input value="${requestScope.category.category_id}"  readonly type="text" name="category_id">
                            </div>
                        </div>
                        <div class="row">
                            <div class="cell">
                                <label>Category</label>
                                <input value="${requestScope.category.category_name}" type="text" name="category_name" required>
                            </div>
                        </div>
                        <div class="cell">
