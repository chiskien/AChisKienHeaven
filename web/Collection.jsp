        ...
        <div class="container-fluid" style="padding: 0;">
            ...
            <div class="container-fluid">
                <nav id="navigation">
                    <ul class="links">
                        ...
                        <li class="dropdown">
                            <form role="search" action="ListController" method="get">
                                <label class="label-search" for="search">Search for stuff</label>
                                <input id="search" type="search" placeholder="Search..." name="search" autofocus required class="input-search" />
            ...
            <nav aria-label="breadcrumb" style="background-color: #fff;">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="Collection.jsp">Collections</li>
                </ol>
            </nav>
            <div class='container'>
                <div class="row">
