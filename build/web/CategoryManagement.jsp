    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <div id="content">
                ...
                <h3 style="color: black;">Add a Category?
                    ...
                    <div class="table">
                        ...
                        <c:forEach items="${category}" var="cat">
                            <div class="row">
                                ...
                                <div class="cell">
                                    <a href="UpdateCategoryController?id=${cat.category_id}" style="color: #7386D5">Update</a>
                                    <a href="DeleteCategoryController?id=${cat.category_id}" onclick="submitDelete(${cat.category_id})" 
