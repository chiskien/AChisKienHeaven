        ...
        <div class="wrapper">
            ...
            <div id="content">
                ...
                <h2 style="text-align: center">Welcome to The ChrisKien's Territory</h2>
                 <h3 style="color: black;">Add a new Customer?
                    <a href="SignUp.jsp" style="color: #7386D5;">Click Here</a> 
                    </h3>
                <div class="wrapper">
                    <div class="table">
                        ...
                        <c:forEach items="${list}" var="customer">
                            <div class="row">
                                ...
                                <div class="cell">
                                    <a href="DeleteCustomerController?id=${customer.customer_id}" onclick="submitDelete(${customer.customer_id})" 
